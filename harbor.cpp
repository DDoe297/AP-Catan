...
Harbor::Harbor(Point *StartPoint, Point *EndPoint, HarborType Type, QObject *parent) : QObject(parent)
{
...
Point *Harbor::getStartPoint() const
{
    return startPoint;
}

Point *Harbor::getEndPoint() const
{
    return endPoint;
}

HarborType Harbor::getType() const
{
    return type;
}
