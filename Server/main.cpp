...
//                       true);
//    game.addSettlement(game.getPlayer(3), game.getBoard()->getPoint(2, 6),
//                       true);
...
//    qDebug()<<(int)game.addRoad(game.getPlayer(3), game.getBoard()->getPoint(2, 5),
//                 game.getBoard()->getPoint(2, 6), true);
