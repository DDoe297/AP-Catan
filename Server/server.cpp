...
void Server::incomingConnection(qintptr socketDescriptor)
{
    ...
    connect(worker,SIGNAL(readFromSocket(const QByteArray),this,SLOT(read(const QByteArray))));
    connect(worker,SIGNAL(readFromSocket(const QByteArray),parent(),SLOT(gameTurn()));
